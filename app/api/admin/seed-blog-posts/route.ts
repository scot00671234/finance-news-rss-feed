...
export async function POST(request: NextRequest) {
  try {
    console.log('Starting SEO blog posts seeding...')
    ...
    console.log(`Blog posts seeding completed! Created: ${created}, Updated: ${updated}`)
    
    return NextResponse.json({
      success: true,
      message: `Successfully processed ${seoBlogPosts.length} blog posts`,
      created,
      updated
    })
...
export async function GET() {
  return NextResponse.json({
    message: 'Use POST method to seed blog posts',
    endpoint: '/api/admin/seed-blog-posts',
    method: 'POST'
  })
}
